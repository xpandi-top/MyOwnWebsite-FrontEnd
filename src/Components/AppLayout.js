...
export default function AppLayout() {
    ...
    const handleLogin = function(loginData) {
        const successCallback = (username) => setUser({
            loggedIn: true,
            username: username
        });
        const failedCallback = (msg) => setUser({
            loggedIn: false,
            message: msg
        })
        // login(loginData.username, loginData.password, successCallback, failedCallback);
    ...
    const renderMainView = function(functionality){
        switch (functionality){
            ...
            case "Users":
                return <LoginContainer callBack={handleLogin}/>;
            default:
                return <></>;
        }
    }
